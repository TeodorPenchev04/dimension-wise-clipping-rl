...
from algorithms.disc_replay import (
    prepare_replay_data,
    disc_replay_update,
)
...
from core.replay_filter import select_replay_batches
...
def main():
    ...
    replay_length = config[
        "replay_length"
    ]

    epsilon_b = config[
        "batch_inclusion_epsilon"
    ]
    ...
    # Current rollout is separate, so retain at most
    # L - 1 old batches.
    ...
    while (
        ...
        # ==============================================
        # Select old replay batches
        # ==============================================

        (
            eligible_old_batches,
            replay_scores,
        ) = select_replay_batches(
            actor=actor,
            replay_buffer=(
                replay_buffer
            ),
        ...
        # ==============================================
        # Current rollout becomes replay data
        # ==============================================
